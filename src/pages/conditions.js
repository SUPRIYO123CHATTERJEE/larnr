            ...
            <nav class="navbar navbar-expand-md navbar-dark bg-blue fixed-top">
                <div class="container">
                    <a href="/" class="navbar-brand">
                        <img src="https://larnr.com/images/logo-dark.png" alt="Larnr Education" class="logo-img" />
                    </a>
                    ...
                    <div class="navbar-collapse collapse" id="navbar5">
                        ...
                        <ul class="navbar-nav mr-end">
                            ...
                            <li class="nav-item active">
                                <a class="nav-link hover-nav" href="https://app.larnr.com/register">Register</a>
                            </li>
                            {/* <!-- Authentication Links --> */}
                        </ul>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-9 text-justify">
                            ...
                            <h1>General Terms</h1>
                            <p class="p8">
                                <span class="s1">By accessing and placing an order with<a></a>, you confirm that you are in agreement with and bound by the terms of service contained in the Terms &amp; Conditions outlined below. These terms apply to the entire website and any email or other type of communication between you and <a></a>.
                                    <br /><br />
                                    ...
                                    <br /><br /> <a></a> will not be responsible for any outcome that may occur during the course of usage of our resources. We reserve the rights to change prices and revise the resources usage policy in any moment.
                                </span>
                            </p>
                            <p class="p9"><br /></p>
                            <h1>License</h1>
                            <p class="p10"><span class="s1"><a>com.larnr.app</a> grants you a revocable, non-exclusive, non- transferable, limited license to download, install and use our service strictly in accordance with the terms of this Agreement.
                                <br /><br />
                                These Terms &amp; Conditions are a contract between you and <a>com.larnr.app</a> (referred to in these Terms &amp; Conditions as "<a>com.larnr.app</a>", "us", "we" or "our"), the provider of the <a>com.larnr.app</a> website and the services accessible from the <a>com.larnr.app</a> website (which are collectively referred to in these Terms &amp; Conditions as the "<a>com.larnr.app</a> Service").
                                <br /><br />
                                You are agreeing to be bound by these Terms &amp; Conditions. If you do not agree to these Terms &amp; Conditions, please do not use the  Service. In these Terms &amp; Conditions, "you" refers both to you as an individual and to the entity you represent. If you violate any of these Terms &amp; Conditions, we reserve the right to cancel your account or block access to your account without notice.</span></p> <p class="p6"><br /></p> <h1>Definitions and key terms</h1> <p class="p8"><span class="s1">For this Terms &amp; Conditions:</span></p> <p class="p9"><br /></p> <ul class="ul1"><li class="li8"><span class="s1"><strong>Cookie:</strong> small amount of data generated by a website and saved by your web browser. It is used to identify your browser, provide analytics, remember information about you such as your language preference or login information.<br /></span></li> <li class="li8"><span class="s1"><strong>Company:</strong> when this policy mentions “Company,” “we,” “us,” or “our,” it refers to <a>Medust Technology Pvt Ltd.</a>, <a>438 Chotofinga, Saritripally, Bishorpara, Kolkata-700158, India</a> that is responsible for your information under this Privacy Policy.<br /></span></li>
                                {/* <!---->  */}
                                <li class="li8"><span class="s1"><strong>Country:</strong> where <a>com.larnr.app</a> or the owners/founders of <a>com.larnr.app</a> are based, in this case is <a>Indian</a>.<br />
                                </span></li>
                                <li class="li8"><span class="s1"><strong>Customer:</strong> refers to the company, organization or person that signs up to use the <a>com.larnr.app</a> Service to manage the relationships with your consumers or service users.<br />
                                </span></li>
                                <li class="li8"><span class="s1"><strong>Device:</strong> any internet connected device such as a phone, tablet, computer or any other device that can be used to visit <a>com.larnr.app</a> and use the services.<br />
                                </span></li>
                                ...
                                <li class="li8"><span class="s1"><strong>Personnel:</strong> refers to those individuals who are employed by <a>com.larnr.app</a> or are under contract to perform a service on behalf of one of the parties.<br />
                                </span></li>
                                ...
                                <li class="li8"><span class="s1"><strong>Service:</strong> refers to the service provided by <a>com.larnr.app</a> as described in the relative terms (if available) and on this platform.<br />
                                </span></li>
                            ...
                            <p class="p10"><span class="s1">Thanks for shopping with us. We appreciate the fact that you like to buy the stuff we build. We also want to make sure you
                            ...
                            <p class="p10"><span class="s1">Any feedback, comments, ideas, improvements or suggestions (collectively, "Suggestions") provided by you to us with respect to the service shall remain the sole and exclusive property of us.
                            ...
                            <h1>Contact Us</h1>
                            <p class="p10"><span class="s1">Don't hesitate to contact us if you have any questions.</span></p> <ul class="ul1"><li class="li16"><span class="s3">Via Email: <a>service@larnr.com</a>
                            </span>
                            </li>
                                {/* <!----> <!----> <!----> */}
                            </ul>
                    ...
                    <div class="row m-0 m-md-none">
                        <div class="col-md-6">
                            <p class="text-center text-md-left">
                                &copy; Copyright By Larnr Education. 2022.
                            </p>
                        </div>
                        <div class="col-md-6">
